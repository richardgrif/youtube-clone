...
export default function Upload() {
    ...
    return (
        <>
            <Heading />
            <form className='mt-10 ml-20 text-center'
                onSubmit={async (e) => {
                    e.preventDefault()
            ...
            >
                <div className='flex-1 mb-5'>
                    ...
                    <input type='text' name='name' onChange={(e) => setTitle(e.target.value)}
                        className='border p-1 text-black' required />
                </div>

                <div className='text-sm text-gray-600'>
                    <label className='relative font-medium cursor-pointer my-3 block'>
                        <p className=''>Video thumbnail {image && '✅'}</p> (800 x 450 suggested)
                ...
                <div className='text-sm text-gray-600'>
                    <label className='relative font-medium cursor-pointer my-3 block'>
                        ...
                        <input name='image' type='file' accept='video/*' className='hidden' required
                ...
                <button disabled={title && video && image ? false : true}
